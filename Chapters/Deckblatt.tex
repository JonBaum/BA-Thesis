...
\put(0,1.32){\fontfamily{phv}\selectfont\huge{BA203}}
\end{picture}
\end{addmargin}
%-----------------------------------------------------------------------------
% Titel deiner Arbeit
...
\textbf{\fontfamily{phv}\selectfont{\huge Ermittlung optimierter Gebäudeenergiesysteme für den deutschen Wohngebäudebestand unter besonderer Berücksichtigung von Lüftungsverlusten}}
\end{center}

\addvspace{1.5cm}
\begin{center}
%TODO Falls der deutsche Name noch noetig ist, kommt er in die naechste Zeile
{\fontfamily{phv}\selectfont Determination of optimized building energy systems for the German residential building stock with special consideration of ventilation losses}
\end{center}
