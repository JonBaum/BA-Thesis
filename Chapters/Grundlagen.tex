...
Diese verkörpern allerdings in den meisten Fällen nur Anforderungen an den Neubau oder Sanierungsmaßnahmen. 
Zur Steigerung der Wirtschaftlichkeit solcher Sanierungsmaßnahmen verabschiedete die deutsche Bundesregierung einige Förderprogramme, welche Gebäudebesitzer bei Renovierungsvorhaben finanziell unterstützen.
...
Wie zuvor bereits erwähnt, ist das Ziel dieser Arbeit die Bestimmung verschiedener Maßnahmen, welche für repräsentative Gebäudetypen eine optimale, energetische Lösung bieten.
...
Somit wird mit einem Optimierungsprogramm versucht, eine Problematik mathematisch zu modellieren, um eine rationale Entscheidung über eine beste Lösung zu treffen. 

Im Folgenden stellt Kapitel \ref{subsubsec:Sektion2521} verschiedene Arten der Optimierung sowie diverse Optimierungsprogramme vor, um letztlich das im Rahmen dieser Arbeit verwendete Programm in \ref{subsec:Sektion 252} beschreiben zu können.
...
So kann zunächst die 

LP, NLP, mixed-integer, diskrete/kontinuierliche Variablen, Rechnerzeit, genauigkeitsverluste

Vorstellung Opti.-Programme
