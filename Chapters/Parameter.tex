...
Außerdem erfolgt keine Unterteilung zwischen der Raumnutzung und es wird eine konstante Innentemperatur von 20°C angenommen.
...
In den drei Häusern befinden sich je 10 Wohnungen mit jeweils 72 m\(^2\).
...
Hierzu werden die Öffnungsdauern der Fenster einer Wohnung je Stunde aufsummiert.
...
Somit wird aus den 20 Wohnungen des Forschungsprojekts ein Jahresprofil erzeugt, welches die Dauer einer unbekannten Menge an Fenstern pro Stunde des Jahres beschreibt.
Um sowohl die Außentemperatur als auch die Tageszeit in den Fensteröffnungsprofilen zu berücksichtigen werden Temperaturintervalle mit ähnlichem Nutzerverhalten gebildet. XXXX Tanjas Aussage zu KlassenXXXX
...
Die Temperaturdifferenz kann durch Temperaturprofile, welche bereits in das Optimierungsprogramm eingelesen werden, gebildet werden.
Zur Bestimmung von Profilen der Windgeschwindigkeit wird das Testreferenzjahr des Deutschen Wetterdienstes betrachtet.
