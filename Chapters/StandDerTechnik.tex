...
Bei der maschinellen Lüftung wird eine RLT-Anlage genutzt

\cite{Bohne.2019} Rückwarmegewinnugn 80 - 90 \%; erklärung zentrale/dezentrale RLT
\cite{Asdrubali.2015} Wirkungsgrad in Abhängigkeit des geförderten Volumenstromes zw 96 - 88 \% (drei Tests)
\cite{Milles.2011} Wärmerückgewinnugn 90\% Angaben zum elektrischen Verbauch der Ventilatoren in Abhängigkeit der rückgewonnenen Wärme
\cite{Kamendere.2015} minimal 71 \%, maximal – 86 \%, average – 77 \% (Litauen --> Winter)