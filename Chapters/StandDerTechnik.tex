...
So beispielsweise in Neubauten oder Altbauten mit energetisch sanierter Gebäudehülle.
...
Andererseits steigen mit zunehmendem Luftaustausch die Wärmeverluste, wodurch ökologisch und ökonomisch Nachteilhaft mehr geheizt werden muss. 
...
Beispiele für die einzelnen Kategorien sind in Tabelle \ref{tab: Tabelle3311} dargelegt.
...
Hier werden die Unterschiede zwischen berechnetem Energiebedarf und gemessenem Energieverbrauch mitunter dem Einfluss der Bewohner auf die Lüftungswärmeverluste zugerechnet.
Die genannte Diskrepanz zwischen Verbrauch und Bedarf wird als Rebound-Effekt bezeichnet und in \cite{Haas.2000} näher erläutert.
...
Eine detaillierte Beschreibung dieser Gebäude wird in \cite{Cali.Holistic} vorgestellt.
Auf Basis der Monitoring Daten aus diesem Projekt bestimmen Calì et al. Triebkräfte, welche dazu führen den Fensterzustand zu ändern.
In Tabelle XXXX sind diese Triebkräfte für das Schließen und Öffnen aufgeführt.
Hierbei sind die Gründe nach Wichtigkeit geordnet und beginnen mit den am häufigsten anzutreffenden.
...
Aufgrund der zuvor erläuterten Faktoren entscheidet ein Bewohner ein Fenster zu öffnen.
Hier muss noch auf den Öffnungswinkel, die Fenstergeometrie und die Öffnungsdauer berück
