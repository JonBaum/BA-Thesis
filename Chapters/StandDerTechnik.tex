...
Diese können anschaulich als Stellschrauben beschrieben werden.\\
Zusammenfassend kann eine Optimierung als das Lösen einer Zielfunktion in einem von Restriktionen beschränkten Lösungsraum durch eine Kombination von Variablen umschrieben werden. \cite{Schellong.2016}

Im Folgenden stellt dieses Kapitel verschiedene Arten der Energiesystemoptimierung sowie diverse Optimierungsprogramme vor, um letztlich das im Rahmen dieser Arbeit verwendete Programm in \ref{sec:Sektion 32} zu beschreiben.
...
Letztere sind die Menge aus [0; 1] und werden im Rahmen der Energiesystemoptimierung oft als Option der Kaufentscheidung Energiesystemen oder Schaltzustände der Anlagentechnik genutzt. 
...
Diese werden durch die betrachtete Gebäude- oder Quartiersebene, der Zielfunktion, dem zu optimierenden Energiesystem und der Betrachtung von Auslegung oder Betrieb unterteilt
...
Wie in Iturriaga et al. \cite{Iturriaga.2017} werden nicht-lineare Gleichungen durch stückweise Linearisierung in linear gewandelt.
Dadurch handelt sich bei dem Programm von Pinzon et al. um ein betriebsoptimierendes MILP Problem.
...
Als Nebenbedingungen werden die Nutzung der PV-Anlagen und ES, des Klimageräts und der Beleuchtung sowie der Einhaltung des thermischen Komforts definiert.
...
Zur Deckung des Wärme- und Elektrizitätsbedarfs werden eine Sole-Wärmepumpe, PV und Strombezug aus dem Netz modelliert.
Die Energiespeicherung erfolgt durch einen sensibler Wasserspeicher und eine Batterie.
Ein Teil der nicht-linearen Gleichungen werden linearisiert. 
Da jedoch noch nicht-lineare Zusammenhänge in dem Programm existieren, handelt es sich bei dem Modell um ein MINLP, welches Energiesysteme auf Gebäudeebene optimiert.
Als Zielfunktion des übergeordneten Modells wird die Minimierung der jährlichen Gesamtkosten festgelegt.
Als Ziel der untergeordneten Optimierung werden die jährlichen Betriebskosten der Energieerzeuger minimiert.
...
Das Programm berücksichtigt neben Energieerzeugern und -speichern wie Kessel, BHKW, Elektroheizstäbe, Wärmepumpen, Solarthermie, PV und thermischen sowie elektrischen Speichern auch energetische Ertüchtigungen der Außenwand, der Fenster, des Daches und der Bodenplatte.
Als Optimierungsziel kann zwischen Jahres-Kosten- und Emissionsminimierung gewählt werden.
...
Autor &\begin{tabular}[c]{@{}l@{}}Art der\\ Optimierung/ \\ Betrachtung \end{tabular} & Ebene & Energiesysteme & \begin{tabular}[c]{@{}l@{}}Zielfunktion\\ (Minimierung von...)\end{tabular} \\ \hline
Iturriaga et al. & \begin{tabular}[c]{@{}l@{}}MILP\\ Auslegung\end{tabular} & Gebäude &  & Jährliche Kosten \\ \hline
\rowcolor[HTML]{EFEFEF} 
Pinzon et al. & \begin{tabular}[c]{@{}l@{}}MILP\\ Betrieb\end{tabular} & Gebäude & PV, ES,Klimageräte & \begin{tabular}[c]{@{}l@{}}Jährliche Elektri-\\ zitätskosten\end{tabular} \\ \hline
Risbeck et al. & \begin{tabular}[c]{@{}l@{}}MILP\\ Betrieb\end{tabular} & Gebäude & Lüftungssysteme & \begin{tabular}[c]{@{}l@{}}Jährliche Betriebs-\\ kosten\end{tabular} \\ \hline
\rowcolor[HTML]{EFEFEF} 
Zhu et al. & \begin{tabular}[c]{@{}l@{}}MINLP\\ Auslegung und \\ Betrieb \end{tabular} & Gebäude & PV, WP, ES & \begin{tabular}[c]{@{}l@{}}Jährliche Betriebs-\\ kosten\end{tabular} \\ \hline
Asadi et al. & \begin{tabular}[c]{@{}l@{}}MINLP\\ Auslegung\end{tabular} & Gebäude & \begin{tabular}[c]{@{}l@{}}Sanierung von Wand, \\ Dach, Fenster/\\ Solarkollektoren\end{tabular} & \begin{tabular}[c]{@{}l@{}}Kosten und\\ Emissionen\end{tabular} \\ \hline
\rowcolor[HTML]{EFEFEF} 
Wouters et al. & \begin{tabular}[c]{@{}l@{}}MILP\\ Auslegung und \\ Betrieb\end{tabular} & Quartier & \begin{tabular}[c]{@{}l@{}}Kessel, BHKW, ES, \\ PV, WKA\end{tabular} & Jährliche Kosten \\ \hline
Harb et al. & \begin{tabular}[c]{@{}l@{}}MILP\\ Auslegung\end{tabular} & \begin{tabular}[c]{@{}l@{}}Gebäude/\\ Quartier\end{tabular} & \begin{tabular}[c]{@{}l@{}}Mikro-BHKW, WP,\\ Elektroheizstäbe, PV, \\ thermische ES, Kessel, \\ Nahwärmenetz\end{tabular} & Jährliche Kosten \\ \hline
\rowcolor[HTML]{EFEFEF} 
Schütz et al. & \begin{tabular}[c]{@{}l@{}}MILP\\ Auslegung und \\ Betrieb\end{tabular} & Gebäude & \begin{tabular}[c]{@{}l@{}}Kessel, BHKW, \\ EHS, WP, Solarthermie, \\ PV, ES/\\ Sanierung von Wand, \\ Dach, Fenster, Boden,\end{tabular} & \begin{tabular}[c]{@{}l@{}}Kosten und/\\ oder Emissionen\end{tabular} \\ \hline
\end{tabular}
...
In Kapitel \ref{subsec:Sektion322} wird die Berechnung der Wärmeverluste anhand der U-Werte und der Bauteilflächen näher erläutert.\\
...
Das Referenzgebäude wird mit derselben Geometrie wie die des parametrisierten Gebäudes ausgeführt, besitzt allerdings eine Gebäudehülle nach EnEV-Vorgaben.
Diese sind in Tabelle \ref{tab: Tabelle322} aufgeführt.
...
Durch die Energieerzeugung in Gebäuden mit fossilen Brennstoffen wird CO\(_2\) freigesetzt. 
...
n = \frac{\Dot{V}_{Luft}}{V_z} \cdot 3600\frac{s}{h} \quad,
\end{equation}
wobei \(\Dot{V}_{Luft}\) den eintretenden Luftvolumenstrom und V\(_Z\) das Volumen der Zone beschreibt.

Die Lüftungswärmeverluste werden in dem Optimierungsprogramm durch das Heizperiodenverfahren in DIN V 4108-6 modelliert.
...
\end{equation}
Zuletzt wird durch Berücksichtigung des Korrekturfaktor aufgrund von Nachtabschaltung der Heizung (f\(_{NA} = 0,95\)) und des Gradtagzahlfaktor (G\(_t\)) die jährlichen Lüftungswärmeverluste zu
\begin{equation}
...
Somit sind diese Verluste in dem Modell konstant und als statisch betrachtet werden.
...
Man unterscheidet hierbei zwischen natürlicher Lüftung, welche durch Temperatur- und Windeinwirkung hervorgerufen wird und maschineller Lüftung\cite{Maas.2017}.
...
So beispielsweise in Niedrigenergiehäusern oder Altbauen mit energetisch aufgerüsteter Gebäudehülle. \cite{BorschLaaks.2011}
...
Zur Berechnung des eintretenden Luftvolumenstroms q\(_V\) wird dieser in Fensteröffnungsvolumenstrom (q\(_{V, Fenster}\)), Infiltrationsvolumenstrom (q\(_{V, Inf}\)) und maschineller Lüftungsvolumenstrom (q\(_{V, Maschinell}\)) aufgeteilt.
...
Der Unterschiede zwischen berechnetem Energiebedarf und gemessenem Energieverbrauch wird unter anderem dem Einfluss der Bewohner auf die Lüftungswärmeverluste zugeschrieben.
...
Raumtemperatur & CO\(_2\)-Konzentration \\ \hline
\rowcolor[HTML]{EFEFEF} 
...
Durch den Ausgleich dieses Gefälles kommt es zum Luftaustausch zwischen dem Gebäude und der Umgebung.
Analog induziert die Temperaturdifferenz eine Luftbewegung zum Ausgleich des thermischen Gefälles. \cite{Maas.2017} \\
...
Gleichzeitig reagiert ein Nutzer mit kurzen Fensteröffnungszeiten aufgrund des thermischen Unbehaglichkeit. 
...
Zwar bildet der durch Wind induzierte Luftvolumenstrom durch ein Fenster den größeren Anteil des Gesamtvolumenstroms ab, allerdings wird gezielt ein minimaler Volumenstrom ermittelt, der aus bauphysikalischer und hygienischer Sicht sichergestellt werden muss.
Zudem wird laut Hall ein Fenster bei zunehmendem Wind schnell geschlossen und es kann weiterhin in der Realität zu Windstille kommen.\\
...
\end{equation}
Der Parameter C\(_d\) wird durch Messungen bestimmt und nimmt dimensionslose Werte zwischen 0,39 und 0,65 an. 

Ein weiterer Berechnungsansatz zur Bestimmung des Luftvolumenstroms durch ein geöffnetes Fenster bietet die DIN EN 12831.
...
Unter Vernachlässigung der Fassadenausrichtung ergibt sich der Volumenstrom zu
\begin{equation}
...
Somit ergibt sich q\(_{V,open,th}\) zu
\begin{equation}
...
In die Gleichung des durch Wind verursachten Volumenstroms wird die Windgeschwindigkeit in Fassadenhöhe (v\(_{fac}\)) benötigt.
